...
// COMENZAR SEMÁFOROS:
	...
	//Lo primero que hacen es poner todos los elementos <td> en opacidad 0.3
		//El intervalo de tiempo 120 quita la opacidad al rojo del semáforo 1 y el verde del semáforo 2
			function tiempo120(){
				...
				document.getElementsByClassName("rojo")[0].style.opacity= "1";  //el peaton siempre está en rojo
				document.getElementsByClassName("rojo")[1].style.opacity= "1";
			}
		//El intervalo de tiempo 60 quita la opacidad al verde del semáforo 1 y el rojo del semáforo 2
			function tiempo60(){
				for(var i=0; i<document.getElementsByTagName("td").length; i++){
					document.getElementsByTagName("td")[i].style.opacity= "0.3";
				}
		...
		//Y el intervalo de tiempo 1 quita la opacidad al amarillo de los dos semáforos
			function tiempo1(){
				for(var i=0; i<document.getElementsByTagName("td").length; i++){
					document.getElementsByTagName("td")[i].style.opacity= "0.3";
				}
		...
		function comenzar(){
			//pinto todos los elementos de los semáforos:
