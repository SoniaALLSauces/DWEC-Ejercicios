	...
	//Rellenamos los Arrays con .push():
		...
		//Pasamos clientes con datos:
			...
			anadir ('11111A','Cliente1','Apellido1','Apellido1','ES11111',new Date(2016,4,16),-100,'Gestor1');
				alert (anadir ('11111A','Cliente1','Apellido1','Apellido1','ES11111',new Date(2016,4,16),-100,'Gestor1'));
				// if (anadir ('11111A','Cliente1','Apellido1','Apellido1','ES11111',new Date(2016,4,16),-100,'Gestor1')){
					// alert ("Cliente 1 NO añadido"); }
			anadir ('22222B','Cliente2','Apellido2','Apellido2','ES22222',new Date(2016,5,5),-200,'Gestor1');
				alert (anadir ('22222B','Cliente2','Apellido2','Apellido2','ES22222',new Date(2016,5,5),-200,'Gestor1'));
				// if (anadir ('22222B','Cliente2','Apellido2','Apellido2','ES22222',new Date(2016,5,5),-200,'Gestor1')){
					// alert ("Cliente 2 NO añadido"); }
			//cliente con cuenta duplicada
			anadir ('22222B','Cliente2','Apellido2','Apellido2','ES22222',new Date(2016,5,23),320,'Gestor2');
				alert (anadir ('22222B','Cliente2','Apellido2','Apellido2','ES22222',new Date(2016,5,23),320,'Gestor2'));
				// if (anadir ('22222B','Cliente2','Apellido2','Apellido2','ES22222',new Date(2016,5,23),320,'Gestor2')){
					// alert ("Cliente 3 NO añadido"); }
			//cliente existente con distinto gestor
			anadir ('22222B','Cliente2','Apellido2','Apellido2','ES22223',new Date(2016,7,13),430,'Gestor2');
				if (anadir ('22222B','Cliente2','Apellido2','Apellido2','ES22224',new Date(2016,7,13),430,'Gestor2')){
					alert ("Cliente 4 NO añadido"); }
			anadir ('22222B','Cliente2','Apellido2','Apellido2','ES22224',new Date(2016,9,14),-300,'Gestor1');
				if (anadir ('22222B','Cliente2','Apellido2','Apellido2','ES22222',new Date(2016,9,14),-300,'Gestor1')){ 
					alert ("Cliente 5 NO añadido"); }
			anadir ('33333C','Cliente3','Apellido3','Apellido3','ES33333',new Date(2017,1,16),300,'Gestor2');
				if (anadir ('33333C','Cliente3','Apellido3','Apellido3','ES33333',new Date(2017,1,16),30,'Gestor2')){ 
					alert ("Cliente 6 NO añadido"); }
			anadir ('33333C','Cliente3','Apellido3','Apellido3','ES33334',new Date(2017,5,2),-200,'Gestor2');
				if (anadir ('33333C','Cliente3','Apellido3','Apellido3','ES33334',new Date(2017,5,2),-200,'Gestor2')){ 
					alert ("Cliente 7 NO añadido"); }
			anadir ('44444D','Cliente4','Apellido4','Apellido4','ES44444',new Date(2017,7,18),400,'Gestor1');
				if (anadir ('44444D','Cliente4','Apellido4','Apellido4','ES44444',new Date(2017,7,18),400,'Gestor1')){ 
					alert ("Cliente 8 NO añadido"); }
			anadir ('55555E','Cliente5','Apellido5','Apellido5','ES55555',new Date(2017,10,10),-500,'Gestor2');
				if (anadir ('55555E','Cliente5','Apellido5','Apellido5','ES55555',new Date(2017,10,10),-500,'Gestor2')){ 
					alert ("Cliente 9 NO añadido"); }
			anadir ('11111A','Cliente1','Apellido1','Apellido1','ES11112',new Date(2018,10,12),1000,'Gestor1');
				if (anadir ('11111A','Cliente1','Apellido1','Apellido1','ES11112',new Date(2018,10,12),1000,'Gestor1')){ 
					alert ("Cliente 10 NO añadido"); }
			anadir ('44444D','Cliente4','Apellido4','Apellido4','ES44445',new Date(2018,12,10),400,'Gestor1');
				if (anadir ('44444D','Cliente4','Apellido4','Apellido4','ES44445',new Date(2018,12,10),400,'Gestor1')){ 
					alert ("Cliente 11 NO añadido"); }
			anadir ('66666F','Cliente6','Apellido6','Apellido6','ES66666',new Date(2019,2,10),300,'Gestor1');
				if (anadir ('66666F','Cliente6','Apellido6','Apellido6','ES66666',new Date(2019,2,10),300,'Gestor1')){ 
					alert ("Cliente 12 NO añadido"); }
	...
	//MENU DEL EJERCICIO:
		...
		switch (opcion){
			...
			case 5:
				...
				var anyoAnt= fecha.getFullYear()-2;  //variables para sacar la fecha de hoy y restarle dos años
				...
				for (var i=0; i<dniS.length; i++){//compruebo si el dni se duplica lo elimino del array lista
					for(var j=0; j<i; j++){
						if (dniS[i]==dniS[j]){
							delete lista[i];
						}
